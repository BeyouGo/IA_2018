...
class PacmanAgent(Agent):
    ...
    def scoreEvaluationFunction(self, current_game_state):
        ...
        if [util.manhattanDistance(pos, xy2) for xy2 in foodlist]:
            list = [util.manhattanDistance(current_game_state.getPacmanPosition(), xy2) for xy2 in foodlist]
            nearfooddist = sum(list)
        ...
        evfun = current_game_state.getScore() - nearfooddist * 1.5 - numfood * 20 - distghost
        return evfun
        #
